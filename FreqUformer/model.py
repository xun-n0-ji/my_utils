...
class LeWinTransformerBlock(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, win_size=8, shift_size=0,
        ...
        elif token_mlp=='ResBlock_do_fft_bench':
            from FFTResBlock import ResBlock_do_fft_bench
            self.mlp = ResBlock_do_fft_bench(dim)
...
if __name__ == "__main__":
    ...
    model_restoration = Uformer(img_size=input_size, embed_dim=16,depths=depths,
                 win_size=8, mlp_ratio=4., token_projection='linear', token_mlp='ResBlock_do_fft_bench', modulator=True, shift_flag=False)
