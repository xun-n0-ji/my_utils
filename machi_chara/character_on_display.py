...
from gif_edit.mask_GB import get_mask
...
class CharacterOnDisplayApp:
    ...
    def __init__(self, video_path, r = 1.0):
        self.root = tk.Tk()
        # ウィンドウを全画面に設定
...
if __name__ == '__main__':
    CharacterOnDisplayApp("image\ms_minutes_walking_GB - Made with Clipchamp.mp4", r=0.5)